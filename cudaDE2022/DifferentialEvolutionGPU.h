...
#define COST_QUADRATIC        0
#define COST_WITH_ARGS        1
#define COST_MANY_LOCAL_MINMA 2
#define COST_3D               3
#define COST_CUSTOM           4
#define COST_SELECTOR         COST_QUADRATIC
...
void differentialEvolution(float* d_target, float* d_trial, float* d_cost, float* d_target2, float* d_min, float* d_max, float* h_cost, void *randStates, int dim, int popSize, int maxGenerations, int CR, float F, void *costArgs, float* h_output);
